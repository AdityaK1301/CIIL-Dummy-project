...
export async function Section2() {
  ...
  return (
    <section id="bestSelling" className="w-full py-10 bg-white px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex overflow-x-auto gap-6 sm:grid sm:grid-cols-2 lg:grid-cols-3 sm:overflow-visible">
          {books.map((book, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-b object-cover from-black/80 via-black/50 to-transparent z-10" />
              ...
              <div className="relative z-20 text-white">
                ...
                <div className="flex items-center justify-between">
                  <span className="font-bold text-lg text-white">₹{book.actual_price}</span>
